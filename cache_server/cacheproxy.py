...
def main():
    #Getting the port command argument
    ...
    print('The Cache proxy is listening on port %s....' % SERVER_PORT)
...
def fetch_from_server(filename):
    url = 'http://127.0.0.1:8000' + filename # Doubt/problem over here
    q = Request(url)
